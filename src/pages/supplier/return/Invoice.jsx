...
function Invoice(){
    ...
    useEffect(()=>{
        ...
        fetch(`${url}/return/supplier/${id}`).then((data)=>data.json()).then((data)=>{
    ...
    return(
        <Layout>
            <div className=" bg-white drop-shadow-md w-11/12 mx-auto mt-4 rounded-sm  h-max p-4">
                <a href={"/supplier/return/print/"+id} rel="noreferrer" target="_blank"><i className="fa-solid fa-print text-orange-500"></i></a>
